...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libComponent = __webpack_require__(1);

	var _libComponent2 = _interopRequireDefault(_libComponent);

	var _componentsCreate = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component = (function () {
	  ...
	  _createClass(Component, null, [{
	    ...
	    value: function register(Class, selector) {

	      if (!Class || !(0, _lodash.isFunction)(Class)) return;

	      var elements = (0, _lodash.toArray)(document.querySelectorAll(selector));

	      elements.forEach(function (el) {
	        return Component.bind(Class, el);
	      });
	    ...
	    value: function reload() {
	      ...
	      Object.keys(components).forEach(function (selector) {
	        return Component.register(components[selector], selector);
	      });
	    }
	  }, {
	    key: 'bind',
	    value: function bind(Class, el) {
	      ...
	      if (typeof el[hiddenProp] === "undefined") el[hiddenProp] = new (_bind.apply(Class, [null].concat([el], args)))();
	    }

	    // retrieve the instance of Class from an element
	  }, {
	    key: 'getInstance',
	    value: function getInstance(Class, el) {
	    ...
	    key: 'deleteInstance',
	    value: function deleteInstance(Class, el) {
	    ...
	    key: 'parseSchema',
	    value: function parseSchema(schema, el, options) {
	      var _extend = (0, _lodash.extend)({ prefix: 'data-' }, options);

	      var prefix = _extend.prefix;
	      ...
	      Object.keys(schema).forEach(function (key) {
	        ...
	        var attrKey = _key$split2[0];
	        var objKey = _key$split2[1];

	        var attr = el.getAttribute(prefix + snake_case(attrKey));

	        if (attr !== null) return out[objKey || attrKey] = parse(schema[key], attr);
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _browserRequest = __webpack_require__(6);

	var _browserRequest2 = _interopRequireDefault(_browserRequest);

	var POST_METHODS = ['get', 'start', 'stop', 'remove'];

	// create Posts
	POST_METHODS.forEach(function (method) {
	  return exports[method] = createPost(method);
	});
